...
.p408 #face {
  animation: p408-spin 2s linear infinite;
...
.p408 #arm {
  animation: p408-swing 0.8s ease-in forwards;
  transform-box: fill-box;
  transform-origin: top center;
}

/* ── Loading bar blink ── */
@keyframes p408-blink {
  100% { opacity: 0; }
}

.p408 #loading-bar path {
  animation: p408-blink 1s linear infinite;
}
.p408 #loading-bar path:nth-child(1) { animation-delay: 50ms; }
.p408 #loading-bar path:nth-child(2) { animation-delay: 100ms; }
.p408 #loading-bar path:nth-child(3) { animation-delay: 150ms; }
.p408 #loading-bar path:nth-child(4) { animation-delay: 200ms; }
.p408 #loading-bar path:nth-child(5) { animation-delay: 250ms; }
.p408 #loading-bar path:nth-child(6) { animation-delay: 300ms; }
...
.p408 #loading-face {
  animation: p408-swap 8s linear 5s infinite;
}

/* ── Server text reveal ── */
@keyframes p408-reveal {
  100% { transform: scale(1); }
}

.p408 #server-text {
  animation: p408-reveal 0.5s linear 2s forwards;
  transform: scale(0);
  transform-box: fill-box;
  ...
  return (
    <div className="p408">
      ...
      >
        <g transform="matrix(.79708 0 0 .79838 32.505 266.5)">
          <g id="arm">
            <g id="pointer" transform="matrix(0,1,-1,0,411.08,-136.64)">
              <path strokeLinejoin="round" style={{colorRendering:"auto",color:"#000000",isolation:"auto",mixBlendMode:"normal",shapeRendering:"auto",imageRendering:"auto"}}
                ...
                stroke="#ffffff" strokeWidth="1.2535" fill="#ffffff" />
              <path d="m563.86 113.11h-5v10h5v-10zm-5 10h-45v5h20v10h5v-10h20v-5zm-25 15h-20v5h15v10h5v-15zm-5 15h-20v5h15v5h5v-10zm-5 10h-5v5h5v-5zm-5 5h-25v5h25v-5zm-25 0v-5h-15v5h15zm-15-5v-5h-10v-40h10v-5h5v-5h-10v5h-10v50h15zm5-55h10v-5h-10v5zm10-5h10v-5h-10v5zm10-5h5v-5h-5v5zm5-5h10v-5h-10v5zm10 0v10h5v-10h-5zm0 10h-5v5h-10v5h55v-5h-40v-5z"
                style={{colorRendering:"auto",color:"#000000",isolation:"auto",mixBlendMode:"normal",shapeRendering:"auto",imageRendering:"auto"}}
                fill="#1a1a1a" />
            </g>
            ...
            <g strokeLinejoin="round" transform="matrix(0,1,-1,0,411.08,-136.64)" stroke="#1a1a1a" strokeWidth="6.2676">
              <rect id="sleeve" style={{colorRendering:"auto",color:"#000000",isolation:"auto",mixBlendMode:"normal",shapeRendering:"auto",imageRendering:"auto"}}
                transform="rotate(90)" height="195" width="55" y="-468.86" x="109.72" fill="#808080" />
              <rect id="band" style={{colorRendering:"auto",color:"#000000",isolation:"auto",mixBlendMode:"normal",shapeRendering:"auto",imageRendering:"auto"}}
                height="55" width="20" y="109.81" x="432.2" fill="#a05a2c" />
              <g id="face">
                <circle id="case" style={{colorRendering:"auto",color:"#000000",isolation:"auto",mixBlendMode:"normal",shapeRendering:"auto",imageRendering:"auto"}}
                  cy="137.31" cx="442.33" r="20" fill="#ffffff" />
                <path id="dial" style={{colorRendering:"auto",color:"#000000",isolation:"auto",mixBlendMode:"normal",shapeRendering:"auto",imageRendering:"auto"}}
          ...
          <g strokeLinejoin="round" fillRule="evenodd" stroke="#1a1a1a" strokeWidth="6.2676">
            ...
            <path d="m347.5 108.61-184.82-106.11-160.18 91.962 184.82 106.11 160.18-91.96" strokeWidth="6.2678" fill="#999999" />
            <g id="a" strokeLinejoin="round" strokeWidth="6.2676" stroke="#1a1a1a">
              <g fill="#2aff80" fillRule="evenodd">
                <path d="m322.86 165.2v14.148l-12.322 7.0743v-14.148z" strokeWidth="6.2676" />
                <path d="m322.86 193.5v14.148l-12.322 7.0742v-14.148z" strokeWidth="6.2676" />
                <path d="m322.86 221.79v14.148l-12.322 7.0742v-14.148z" strokeWidth="6.2676" />
                <path d="m261.25 200.57v14.148l-12.322 7.0739v-14.148z" strokeWidth="6.2676" />
                <path d="m261.25 228.87v14.148l-12.322 7.0738v-14.148z" strokeWidth="6.2676" />
                <path d="m261.25 257.16v14.148l-12.322 7.0738v-14.148z" strokeWidth="6.2676" />
              </g>
              <path d="m335.18 143.98v99.037l-135.54 77.814v-99.037z" strokeWidth="6.2676" fill="none" />
              <g fill="#333333" fillRule="evenodd">
                <path d="m236.61 271.31v14.148l-24.643 14.148v-14.148z" strokeWidth="6.2676" />
                <path d="m298.21 179.35v14.148l-24.643 14.148v-14.148z" strokeWidth="6.2676" />
                <path d="m298.21 207.65v14.148l-24.643 14.148v-14.148z" strokeWidth="6.2676" />
                <path d="m298.21 235.94v14.148l-24.643 14.148v-14.148z" strokeWidth="6.2676" />
                <path d="m236.61 214.72v14.148l-24.643 14.148v-14.148z" strokeWidth="6.2676" />
                <path d="m236.61 243.02v14.148l-24.643 14.148v-14.148z" strokeWidth="6.2676" />
              </g>
            </g>
          </g>

          <use xlinkHref="#a" transform="translate(-4.5832e-6,113.18)" height="100%" width="100%" y="0" x="0" />
          <use xlinkHref="#a" transform="translate(-4.5832e-6,226.37)" height="100%" width="100%" y="0" x="0" />

          <g strokeLinejoin="round" fillRule="evenodd" stroke="#1a1a1a" strokeWidth="6.2676" fill="#ff5555">
        ...
        <g fillRule="evenodd" transform="matrix(.75933 0 0 .75983 497.63 26.367)">
          <g strokeWidth="1.3165" stroke="#6c5353">
            <g strokeLinejoin="round" strokeWidth="1.3165">
              <g fill="#e3dedb">
                <g strokeWidth="6.5826">
                ...
                <path d="m285.06 304.11v38.976l33.755-19.488v-38.976z" strokeWidth="3.9496" />
              </g>
              <path d="m291.2 307.66c-4.1338 7.16-7.16 20.669 0 24.803 7.16 4.1339 17.346-5.2415 21.48-12.402 4.1339-7.1601 7.1601-20.669 0-24.803-7.1601-4.1339-17.346 5.2415-21.48 12.402z"
                strokeWidth="3.9496" fill="#c8beb7" />
              <g strokeWidth="3.9496" fill="#e3dedb">
            ...
            <g id="floppy-drive" fillRule="evenodd" transform="translate(-157.44,-155.68)" stroke="#6c5353" strokeWidth="1.3165">
              <g strokeLinejoin="round">
                <path d="m181.42 425.69v38.976l61.372 35.433v-38.976z" strokeWidth="3.9496" fill="#e3dedb" />
                <path d="m184.49 445.18 21.48 12.402v3.5433l12.274 7.0866v-3.5433l21.48 12.402v-7.0866l-55.235-31.89z"
                  strokeWidth="3.2913" fill="#c8beb7" />
                <path d="m190.62 452.27v3.5433l6.1372 3.5433v-3.5433z" strokeWidth="2.633" fill="#afe9af" />
              </g>
              <g strokeLinejoin="round" strokeWidth="1.3165" fill="#c8beb7">
                <path d="m221.31 473.53v7.0867l6.1372 3.5433v-7.0866z" strokeWidth="2.633" />
                <path d="m221.31 473.53 3.0686-1.7717 6.1372 3.5434-3.0686 1.7716z" strokeWidth="2.633" />
                <path d="m227.45 484.16 3.0686-1.7716v-7.0866l-3.0686 1.7716z" strokeWidth="2.633" />
                <path d="m184.49 445.18 6.1372-3.5433-6.1372-3.5433z" strokeWidth="3.2913" />
                <path d="m205.97 457.58 6.1372-3.5433 3.0686 1.7717-9.2058 5.3149z" strokeWidth="3.2913" />
              </g>
              <path d="m218.24 464.67 6.1372-3.5433" strokeWidth="3.2913" fill="#e3dedb" />
            </g>

            <g strokeWidth="6.5826" fill="#c8beb7">
              <g strokeLinejoin="round">
            ...
            <g strokeLinejoin="round">
              <g strokeWidth="6.5826" fill="#e3dedb">
              ...
              <path d="m174.34 307.22v10.63l15.343 8.8582v-10.63z" strokeWidth="3.9496" fill="#c8beb7" />
              <path d="m162.07 301.91v3.5433l6.1372 3.5433v-3.5433z" strokeWidth="2.633" fill="#ff5555" />
              <g strokeWidth="3.2913" fill="#c8beb7">
          ...
          <g id="sad-face" transform="translate(-157.44,-155.68)">
            <path strokeLinejoin="round"
              d="m209.03 262.7s-3.0686 19.488-3.0686 51.378 3.0686 51.378 3.0686 51.378l131.95 76.181v-99.213c0-2.0457-1.2969-4.2921-3.0686-5.315z"
              stroke="#6c5353" strokeWidth="6.5826" fill="#1a1a1a" />
        ...
        <use xlinkHref="#floppy-drive" transform="matrix(.75933 0 0 .75983 558.21 61.367)" height="100%" width="100%" y="0" x="0" />

        <g id="loading-face" transform="matrix(.75933 0 0 .75983 497.63 26.36)">
          <path strokeLinejoin="round"
            d="m51.598 107.03s-3.0686 19.488-3.0686 51.378 3.0686 51.378 3.0686 51.378l131.95 76.181v-99.213c0-2.0457-1.2969-4.2921-3.0686-5.315z"
            fillRule="evenodd" stroke="#6c5353" strokeWidth="6.5826" fill="#1a1a1a" />
          <path strokeLinejoin="round" d="m63.872 151.32v24.803l98.195 56.693v-24.803z"
            stroke="#e9ddaf" strokeWidth="3.2913" fill="none" />
          <g id="loading-bar" fill="#e9ddaf" fillRule="evenodd">
        ...
        <g id="server-text">
          <path id="text-bubble" strokeLinejoin="round"
            style={{colorRendering:"auto",color:"#000000",isolation:"auto",mixBlendMode:"normal",shapeRendering:"auto",imageRendering:"auto"}}
            d="m370.45 601.16h223.36v-150.24h-251.54l28.186 24.244z"
            stroke="#000000" strokeLinecap="round" strokeWidth="5" fill="#ffffff" />
          <g fill="#000000">
      ...
      <div className="p408-text">408 TIMEOUT</div>

      <button className="p408-btn" onClick={() => setLocation("/")}>
        Go Home
      </button>
    </div>
  );
